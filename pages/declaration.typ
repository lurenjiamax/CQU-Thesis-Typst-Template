...
#let declaration-content(title) = {
  ...
  align(left)[
    #table(
      ...
      stroke: none,
      inset: 5pt,
      [论文（设计）作者签名: #empty_underline(6em)],
      [日期：#empty_underline(6em)],
    )
  ]
  ...
  align(left)[
    #table(
      ...
      stroke: none,
      inset: 5pt,
      [论文（设计）作者签名：#empty_underline(6em)], [指导教师签名：#empty_underline(6em)],
      [日期：#empty_underline(6em)], [日期：#empty_underline(10em)],
    )
  ]
}
